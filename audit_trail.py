...
class OperationType(str, Enum):
    ...
    DOUBT_RESOLVE = '疑点解决'
    CITATION_DETECT = '引文检测'
    CITATION_CREATE = '引文创建'
    CITATION_UPDATE = '引文更新'
    CITATION_REVIEW = '引文复核'
    CITATION_INVALIDATE = '引文失效'
    CASE_CREATE = '判例创建'
    CASE_UPDATE = '判例更新'
    CASE_INVALIDATE = '判例失效'
    CASE_REACTIVATE = '判例重新激活'
    RECOMMENDATION_GENERATE = '推荐生成'
    RECOMMENDATION_ACCEPT = '推荐采纳'
    RECOMMENDATION_REJECT = '推荐驳回'
    RECOMMENDATION_MODIFY = '推荐修订'
    RECOMMENDATION_INVALIDATE = '推荐失效'
    ROLE_ASSIGN = '角色分配'
    RULE_UPDATE = '规则更新'
    EXPORT = '数据导出'
    LOGIN = '登录'
